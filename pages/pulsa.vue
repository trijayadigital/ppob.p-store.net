...
<template>
  <Card>
    ...
    <CardContent class="space-y-4">
      ...
      <ProductSelector v-model="selectedProduct" :products="products" :columns="4" :show-description="true">
        <template #empty-message> Masukkan nomor telepon untuk melihat produk yang tersedia </template>
      </ProductSelector>
    </CardContent>
  </Card>
</template>
