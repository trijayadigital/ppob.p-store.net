...
// Data dari JSON file
const others = ref(data.others);

// Computed untuk mendapatkan service yang dipilih
const selectedServiceData = computed(() => {
  return others.value.find((service) => service.id === selectedService.value);
});
...
<template>
  <Card>
    <CardHeader>
      ...
      <CardDescription>Top up e-wallet dan layanan digital lainnya</CardDescription>
    </CardHeader>
    <CardContent class="space-y-6">
          ...
          <CardContent class="p-0">
            <div class="relative overflow-hidden">
              ...
              <div class="absolute top-2 right-2">
                <span class="inline-block px-2 py-1 bg-black/70 text-white text-xs rounded-full backdrop-blur-sm"> E-Wallet </span>
              </div>
            </div>
      ...
      <div v-if="selectedServiceData" class="mt-8 space-y-6">
        <div class="flex items-center gap-4">
          ...
          <Badge class="bg-green-500 text-white"> E-Wallet </Badge>
        </div>
        ...
        <div v-if="selectedVariant" class="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
          <p class="text-green-800 font-medium">
            ✓ Nominal terpilih: {{ selectedServiceData.variants.find((v) => v.code === selectedVariant)?.name }}
          </p>
        ...
        <div v-if="selectedVariant" class="mt-8 space-y-6">
              ...
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div class="flex items-center gap-2 mt-1">
                    ...
                    <span class="text-sm text-green-600 font-medium">Panduan</span>
                  </div>
                </div>
              </div>
            </CardHeader>
            <CardContent class="space-y-4">
              ...
              <div class="p-3 bg-green-50 border border-green-200 rounded-lg">
                <p class="text-sm text-green-800">
                  ...
                  <button class="text-green-600 underline ml-1">Selengkapnya</button>
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <div class="flex justify-end">
            <button
              class="px-6 py-3 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
